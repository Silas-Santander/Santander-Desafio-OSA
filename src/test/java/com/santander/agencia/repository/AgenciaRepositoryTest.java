...
class AgenciaRepositoryTest {
    ...
    void deveBuscarAgenciasProximasOrdenadasPorDistancia() {
        ...
        List<Object[]> resultados = agenciaRepository.buscarAgenciasProximasComDistancia(posX, posY, limite);
    ...
    void deveRetornarTrueQuandoExisteAgenciaProxima() {
        boolean existeProxima = agenciaRepository.existeAgenciaProxima(0.05, 0.0, 0.1);
    ...
    void deveRetornarTrueQuandoNaoExisteAgenciaProxima() {
        boolean existeProxima = agenciaRepository.existeAgenciaProxima(10.0, 10.0, 0.1);
        assertTrue(existeProxima);
    }
    ...
    void deveRetornarTrueQuandoAgenciaEstaExatamenteNaDistanciaMinima() {
        boolean existeProxima = agenciaRepository.existeAgenciaProxima(0.1, 0.0, 0.1);
        assertTrue(existeProxima);
    }
    ...
    void deveRetornarFalseQuandoAgenciaEstaAlemDaDistanciaMinima() {
        boolean existeProxima = agenciaRepository.existeAgenciaProxima(0.11, 0.0, 0.1);
    ...
    void deveVerificarProximidadeComDiferentesPosicoes() {
        boolean proximaAgencia2 = agenciaRepository.existeAgenciaProxima(3.05, 4.0, 0.1);
        assertTrue(proximaAgencia2);

        boolean distanteAgencia2 = agenciaRepository.existeAgenciaProxima(5.0, 4.0, 0.1);
